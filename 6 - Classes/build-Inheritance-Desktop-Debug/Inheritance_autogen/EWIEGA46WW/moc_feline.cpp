...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Feline_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Feline_t qt_meta_stringdata_Feline = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Feline"
...
QT_INIT_METAOBJECT const QMetaObject Feline::staticMetaObject = { {
    QMetaObject::SuperData::link<Mammal::staticMetaObject>(),
    qt_meta_stringdata_Feline.data,
    qt_meta_data_Feline,
    qt_static_metacall,
    nullptr,
    nullptr
